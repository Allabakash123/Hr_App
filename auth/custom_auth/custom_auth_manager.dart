...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    teamCAuthUserSubject.add(
      TeamCAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TeamCAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TeamCAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TeamCAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    teamCAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
