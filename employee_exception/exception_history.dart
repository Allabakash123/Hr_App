...
import 'package:team_c/employee_exception/edit_exception.dart';
...
import 'package:team_c/employee_exception/history_exception_model.dart';
...
class EmployeeExceptionHistory extends StatefulWidget {
  const EmployeeExceptionHistory({Key? key}) : super(key: key);

  @override
  State<EmployeeExceptionHistory> createState() =>
      _EmployeeExceptionHistoryState();
}

class _EmployeeExceptionHistoryState
    extends State<EmployeeExceptionHistory> {
  late EmployeeExceptionHistoryModel _model;
  final scaffoldKey = GlobalKey<ScaffoldState>();
  List<dynamic> _employeeExcep = [];
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeExceptionHistoryModel());
    _fetchExceptionRecord();
  }
   void LabourexceptionApplications() {
      _fetchExceptionRecord();
  }
...
Future<String?> getAuthToken() async {
   ...
   Future<void> _fetchExceptionRecord() async {
     final token = await getAuthToken();
  
  
  final String? jwt3 = token;

    const String apiUrl = '$apiBaseUrl/hr/api/history-attendace-exception-data';
  ...
  final response = await http.get(
    ...
    if (response.statusCode == 200) {
      setState(() {
        _employeeExcep = json.decode(response.body);
      });
    } else {
      // Handle error
 ...
 Future<void> _deleteResumption(int exceptionId) async {
   final token = await getAuthToken();
  
  
  final String? jwt3 = token;

  final String apiUrl = '$apiBaseUrl/hr/api/delete-attendace-exception-data/$exceptionId';
  ...
  if (response.statusCode == 200) {
    // Remove the deleted exception from the list
    setState(() {
      _employeeExcep.removeWhere((exception) => exception['id'] == exceptionId);
    });
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Employee Exception deleted successfully'),
      ),
    );
  } else {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Failed to delete Ecmployee Exception'),
      ),
    );
  }
}

  Future<Map<String, dynamic>> fetchExceptionData(int ResumptionId) async {
   final token = await getAuthToken();
  
  
  final String? jwt3 = token;

  final String apiUrl = '$apiBaseUrl/hr/api/data-attendace-exception/$ResumptionId';
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                      child: const Text('Employee Exception Details',
                          style: TextStyle(
                    ...
                    children: [
                      IconButton(
                        icon: Padding(
                          ...
                          child: Icon(
                            Icons.edit_outlined,
                            color: employeeData['attendanceException_status'] == 'approved' || employeeData['attendanceException_status'] == 'rejected'
                        ...
                        onPressed: () async {
                          ...
                          final fetchedData = await fetchExceptionData(exceptionId);
                          print('Fetched data of Medical: $fetchedData');
                          if (employeeData['attendanceException_status'] != 'approved' && employeeData['attendanceException_status'] != 'rejected') {
                            Navigator.push(context,
                              MaterialPageRoute(
                                builder: (context) => EmployeeExceptionEditWidget(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['date_of_exception']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.hourglass_bottom, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.timer_outlined, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.hourglass_top, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.access_time_rounded, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['minutes_early_out']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['attendanceException_status']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['attendanceExceptionApplied_date']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            ...
            icon: const Icon(
              ...
              onPressed: () async {
                                  ...
                                  if (token != null) {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => EmployeeExceptionWidget(token:token)),
                                    );
                                  }
                                },
          ...
          title: Text(
            'History of Employee Attendance Exception',
                    ...
                    child: Container(
                      ...
                      child: PaginatedDataTable(
                        ...
                        source: MedicalDataTableSource(
                          medicalApplications: _employeeExcep,
                          onDelete: (index) {
                            final medicalReport = _employeeExcep[index];
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(
      cells: [
        ...
        DataCell(
          Text(
            medicalReport['attendanceException_status'].toString(),
            style: const TextStyle(fontFamily: 'Readex pro'),
          ),
        ),
        DataCell(
          Text(
            medicalReport['attendanceExceptionApplied_date'].toString(),
            style: const TextStyle(fontFamily: 'Readex pro'),
          ),
        ),
        DataCell(
